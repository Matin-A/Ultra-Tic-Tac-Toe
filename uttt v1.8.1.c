...
int main(){
    int user_num_i,user_num_j,un_i,win_check1,win_check2;
    ...
    while (1){                                                                              //game runs in an unlimited cycle
        ...
        for(i=1;i<82;i++){                                                                  //each round starts here (a draw game will takes 81 turns)
            ...
            win_check2=WinCheck2(array);                                                   //to prevent  multiple calculation in next use
            if(win_check2==1) break;
            win_check1=WinCheck1(array,user_num_i);
            if(win_check1==1){
                if (i%2==0){
                    for (s=0;s<9;s++){
                    ...
                    for (s=0;s<9;s++){
                        array[user_num_i][s]=178;
                    }
                    array[user_num_i][4]='O';
                }
                if (user_num_i==user_num_j){
                    printf("\n\304\304\304\304\266 This block is full. Please Choose a block to continue :\n ");
                    un_i=user_num_i;
                    user_num_i=all2numGet()-1;
                    if (user_num_i==-1) break;
                }
            }
            if (!(win_check1==1 && un_i==user_num_j)) user_num_i=user_num_j;
        }
                                                                                            //end of each round
...
{
    if( ( array[0][4]==array[1][4] && array[1][4]==array[2][4] && (array[0][1]==-79 || array[0][1]==-78)) ||
        ( array[3][4]==array[4][4] && array[4][4]==array[5][4] && (array[3][1]==-79 || array[3][1]==-78)) ||
        ( array[6][4]==array[7][4] && array[7][4]==array[8][4] && (array[6][1]==-79 || array[6][1]==-78)) ||
        ( array[0][4]==array[4][4] && array[4][4]==array[8][4] && (array[0][1]==-79 || array[0][1]==-78)) ||
        ( array[2][4]==array[4][4] && array[4][4]==array[6][4] && (array[2][1]==-79 || array[2][1]==-78)) ||
        ( array[0][4]==array[3][4] && array[3][4]==array[6][4] && (array[0][1]==-79 || array[0][1]==-78)) ||
        ( array[1][4]==array[4][4] && array[4][4]==array[7][4] && (array[1][1]==-79 || array[1][1]==-78)) ||
        ( array[2][4]==array[5][4] && array[5][4]==array[8][4] && (array[2][1]==-79 || array[2][1]==-78))  ) return 1;
